...
@section('content')
    <!-- Bordered Table -->
    <a href="{{ url('suppliers/create') }}" class="btn btn-sm btn-primary mb-2">Tambah Suppliers</a>
    <form action="{{ url('/suppliers') }}" method="GET">
    ...
    <div class="card">
        <h5 class="card-header">Suppliers Table</h5>
        <div class="card-body">
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td style="width: 150px">
                                    <a class="btn btn-sm" href="{{ url('/supplier/' . $item->id . '/edit') }}"><i
