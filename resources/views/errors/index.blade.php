...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ url('template') }}/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Oops! 😖 Anda Tidak Boleh Masuk disini!!</p>
        <a href="{{ url('/dashboard') }}" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img
            src="{{ url('template') }}/assets/img/illustrations/page-misc-error-light.png"
