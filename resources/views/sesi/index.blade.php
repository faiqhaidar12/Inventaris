...
>
  <head>
    ...
    <title>Login Pages | Inventaris </title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ url('template') }}/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Inventaris</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Inventaris! 👋</h4>
              <p class="mb-4">Tolong masuk menggunakan akun anda!!</p>
