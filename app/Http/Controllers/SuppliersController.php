...
class SuppliersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = Suppliers::where(function ($query) use ($keyword) {
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'email' => ['required', 'string', 'email', 'max:255', 'unique:' . Suppliers::class],
        ...
        return redirect('suppliers')->with('success', 'Berhasil Tambah Data!!');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('suppliers')->with('warning', 'Berhasil Update Data!!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect('suppliers')->with('error', 'Berhasil Hapus Data!!');
    }
}
